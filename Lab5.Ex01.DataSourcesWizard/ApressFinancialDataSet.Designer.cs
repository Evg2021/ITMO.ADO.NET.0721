...
namespace Lab5.Ex01.DataSourcesWizard {
    ...
    public partial class ApressFinancialDataSet : global::System.Data.DataSet {
        ...
        public partial class CustomersDataTable : global::System.Data.TypedTableBase<CustomersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public CustomersRow AddCustomersRow(string CustomerFirstName, string CustomerOtherInitials, string CustomerLastName) {
...
namespace Lab5.Ex01.DataSourcesWizard.ApressFinancialDataSetTableAdapters {
    ...
    public partial class CustomersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [CustomerDetails].[Customers] WHERE (([CustomerId] = @Original_CustomerId) AND ([CustomerFirstName] = @Original_CustomerFirstName) AND ((@IsNull_CustomerOtherInitials = 1 AND [CustomerOtherInitials] IS NULL) OR ([CustomerOtherInitials] = @Original_CustomerOtherInitials)) AND ([CustomerLastName] = @Original_CustomerLastName))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [CustomerDetails].[Customers] SET [CustomerFirstName] = @CustomerFirstName, [CustomerOtherInitials] = @CustomerOtherInitials, [CustomerLastName] = @CustomerLastName WHERE (([CustomerId] = @Original_CustomerId) AND ([CustomerFirstName] = @Original_CustomerFirstName) AND ((@IsNull_CustomerOtherInitials = 1 AND [CustomerOtherInitials] IS NULL) OR ([CustomerOtherInitials] = @Original_CustomerOtherInitials)) AND ([CustomerLastName] = @Original_CustomerLastName));
SELECT CustomerId, CustomerFirstName, CustomerOtherInitials, CustomerLastName FROM CustomerDetails.Customers WHERE (CustomerId = @CustomerId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Lab5.Ex01.DataSourcesWizard.Properties.Settings.Default.ApressFinancialConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CustomerId, CustomerFirstName, CustomerOtherInitials, CustomerLastName FRO" +
                "M CustomerDetails.Customers";
        ...
        public virtual int Delete(long Original_CustomerId, string Original_CustomerFirstName, string Original_CustomerOtherInitials, string Original_CustomerLastName) {
            ...
            if ((Original_CustomerOtherInitials == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[3].Value = ((string)(Original_CustomerOtherInitials));
            }
        ...
        public virtual int Update(string CustomerFirstName, string CustomerOtherInitials, string CustomerLastName, long Original_CustomerId, string Original_CustomerFirstName, string Original_CustomerOtherInitials, string Original_CustomerLastName, long CustomerId) {
            ...
            if ((CustomerOtherInitials == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[1].Value = ((string)(CustomerOtherInitials));
            }
            ...
            if ((Original_CustomerFirstName == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[4].Value = ((string)(Original_CustomerFirstName));
            }
            if ((Original_CustomerOtherInitials == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[6].Value = ((string)(Original_CustomerOtherInitials));
            }
            if ((Original_CustomerLastName == null)) {
                throw new global::System.ArgumentNullException("Original_CustomerLastName");
            }
            ...
            this.Adapter.UpdateCommand.Parameters[8].Value = ((long)(CustomerId));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string CustomerFirstName, string CustomerOtherInitials, string CustomerLastName, long Original_CustomerId, string Original_CustomerFirstName, string Original_CustomerOtherInitials, string Original_CustomerLastName) {
            return this.Update(CustomerFirstName, CustomerOtherInitials, CustomerLastName, Original_CustomerId, Original_CustomerFirstName, Original_CustomerOtherInitials, Original_CustomerLastName, Original_CustomerId);
        }
    }
